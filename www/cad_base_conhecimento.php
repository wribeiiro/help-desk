		...
		<div class="col-md-12">
			<div class="panel panel-primary">
                <div class="panel-heading">
                	Preencha o formulário da base
                </div>
            	<div class="panel-body">
			  		<form class="form" method="POST" action="processa/proc_cad_base_conhecimento.php" enctype="multipart/form-data">
					  	<div class="col-sm-6">
				  			<div class="form-group">
								<label>Pergunta: </label><span style="color: red; font-weight: bold;"> *</span>
						  		<input type="text" class="form-control" name="pergunta" placeholder="Descrição breve" required>
							</div>
							<div class="form-group">
								<label>Resposta: </label><span style="color: red; font-weight: bold;"> *</span>
						  		<textarea class="form-control" name="resposta" rows="7" placeholder="Procedimentos efetuados" required></textarea>
							</div>
				  		</div>
					  	<div class="col-sm-6">
							<div class="form-group">
							...
							<div class="form-group">
						    	...
						    	<div class="fileinput fileinput-new" data-provides="fileinput">
									<span class="btn btn-default btn-file">
										<input type="file" name="anexo" accept="image/*" multiple/>
									</span>
								</div>
							</div> 
					  	</div>			  	
